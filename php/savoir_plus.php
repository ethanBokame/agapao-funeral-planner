...
<body>
    ...
    <div class="container-nous">
        ...
        <div class="section" id="nos-valeurs">
            <h2>Nos valeurs</h2>
            <p><b>L'accueil </b> : Un accueil chaleureux, empathique et respectueux pour vous accompagner dans ce moment difficile.</p>
            <p><b>L'écoute </b> : Une écoute attentive pour comprendre vos besoins et apporter l'assistance la plus adaptée.</p>
            <p><b>Le professionnalisme </b> : Des prestations de qualité suivant les meilleurs standards avec une équipe professionnelle.</p>
            <p><b>La disponibilité </b> : Une présence constante pour vous soutenir et vous décharger tout au long des obsèques.</p>
            <p><b>La confidentialité </b> : Un respect total de la vie privée et une relation de confiance basée sur l'éthique.</p>
        </div>
